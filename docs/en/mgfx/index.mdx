...
distributed as `@lux/mgfx` through the Lux package set and is documented in its
own site:
...
generated Lua, and generates the GMod loader. Do not copy the old MGFX Lua
autorun loader into a Lux project.
